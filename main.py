...
variants = st.radio("Выберите интересующий вариант анализа из предложенных в списке:",
                    ('Вариант № 2 - Банаев Ю. А.', 'Вариант № 3 - Белинский В. А.'))
...
if variants == 'Вариант № 2 - Банаев Ю. А.':
    if st.checkbox("Спасен?"):
        ...
        save = '0'
    sexr = st.radio("Пол:", ('Мужчина', 'Женщина'))
    if (sexr == 'Мужчина'):
        sex = 'male'
    else:
        sex = 'female'
...
if variants == 'Вариант № 3 - Белинский В. А.':
    st.info("Для вывода имён, возрастов, классов билетов мужчин "
            "указанного возраста (от 30 до 60 лет) необходимо задать возрастной диапазон.")
